...
1. Query analytics store (Redis or PostgreSQL `agent_invocations` table) for the period.
...
RECOMMENDATIONS
  ...
  ℹ Consider A/B testing subject lines for sales_outreach — CTR dropped 3% vs last period
```
